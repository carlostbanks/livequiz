  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingQuestion) {
        ...
        if (error) throw error;
        alert(`Question created successfully!${!formData.answer_text.trim() ? ' (Answer auto-generated by AI)' : ''}`);
      }
            ...
            <div className="modal-content">
              ...
              <form onSubmit={handleSubmit}>
                <div className="modal-body">
                  ...
                  {/* Answer Text */}
                  <div className="mb-3">
                    <label htmlFor="answerText" className="form-label">Expected Answer</label>
                    <input
                      type="text"
                      className="form-control"
                      id="answerText"
                    ...
                    <div className="form-text">
                      ...
                      Or type your own answer for custom responses.
                    </div>
                  </div>
